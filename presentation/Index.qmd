...
## H1/V3: How does the different developer and publisher affect the number of games produced?{auto-animate="true"}
...
::: {.column width="40%"}
``` {.python}
g_3 = ggplot(df_tmp_100_games_different, aes(x='developer',
 y='num_games')) +\
        geom_bar(stat='identity', fill='blue') +\
        labs(title='Number of games produced by different developers and publishers'
        , x='developer', y='num_games') +\
        theme_classic() +\
...
g_4 = ggplot(df_tmp_100_games_same, aes(x='developer', y='num_games')) +\
        geom_bar(stat='identity', fill='blue') +\
        labs(title='Number of games produced by same developers and publishers',
         x='developer', y='num_games') +\
        theme_classic() +\
        theme(axis_text_x=element_text(angle=90, hjust=1), 
        figure_size=(12, 10)) +\
        coord_flip() +\
        scale_x_discrete(limits=df_tmp_100_games_same['developer']
        .tolist()) +\
        scale_y_continuous(breaks=range(0, 10, 2))
...
g_6 = ggplot(df_tmp_100_games, aes(x='developer', y='num_games')) +\
      geom_bar(stat='identity', fill='blue') +\
      labs(title='Number of top 100 games games produced by developers'
      , x='developer', y='num_games') +\
      theme_classic() +\
      theme(axis_text_x=element_text(angle=90, hjust=1), 
      figure_size=(30, 50)) +\
...
## Modeling
```{r, modeling, echo = FALSE, eval = TRUE}
#sqrt version model 
...
```{r, factor-selection, echo = FALSE, eval = TRUE}
#best subset
...
## keep outliers
```{r, keep-outliers, echo = TRUE, eval = TRUE, collapse = TRUE, code_folding=TRUE}
#check  outliers
...
```{r, leverage-points, echo = FALSE, eval = TRUE}
...
```{r, final-model, echo = FALSE, eval = TRUE}
#infuential points
